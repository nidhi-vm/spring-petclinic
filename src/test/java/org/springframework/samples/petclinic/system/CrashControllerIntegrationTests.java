...
class CrashControllerIntegrationTests {
	...
	private static final String ERROR_PATH = "/oups";
	...
	void testTriggerExceptionJson() {
		ResponseEntity<Map<String, Object>> resp = rest.exchange(
				RequestEntity.get("http://localhost:" + port + ERROR_PATH).build(),
		...
		assertThat(resp.getBody()).containsEntry("path", ERROR_PATH);
	}
	...
	void testTriggerExceptionHtml() {
		...
		ResponseEntity<String> resp = rest.exchange("http://localhost:" + port + ERROR_PATH, HttpMethod.GET,
