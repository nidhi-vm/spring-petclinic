...
class ClinicServiceTests {
	...
	private static final String OWNER_LAST_NAME = "Schultz";
	...
	void shouldInsertOwner() {
		Page<Owner> owners = this.ownerRepository.findByLastNameStartingWith(OWNER_LAST_NAME, pageable);
		...
		owners = this.ownerRepository.findByLastNameStartingWith(OWNER_LAST_NAME, pageable);
