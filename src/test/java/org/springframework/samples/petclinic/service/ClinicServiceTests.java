...
class ClinicServiceTests {
	...
	private static final String LAST_NAME = "Schultz";
	...
	void shouldInsertOwner() {
		Page<Owner> owners = this.ownerRepository.findByLastNameStartingWith(LAST_NAME, pageable);
		...
		owners = this.ownerRepository.findByLastNameStartingWith(LAST_NAME, pageable);
