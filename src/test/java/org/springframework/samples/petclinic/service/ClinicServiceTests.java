...
class ClinicServiceTests {
	...
	void shouldInsertOwner() {
		Page<Owner> owners = this.ownerRepository.findByLastNameStartingWith(LAST_NAME_SCHULTZ, pageable);
		...
		owners = this.ownerRepository.findByLastNameStartingWith(LAST_NAME_SCHULTZ, pageable);
